...
class Telegram:
    ...
    START_STICKER = env.get("START_STICKER", "")
    PROCESSING_STICKER = env.get("PROCESSING_STICKER", "")
    SUCCESS_STICKER = env.get("SUCCESS_STICKER", "")
    ERROR_STICKER = env.get("ERROR_STICKER", "")
    NO_STICKERS = str(env.get("NO_STICKERS", "false")).lower() in ("1", "true", "t", "yes", "y")
    MULTI_CLIENT = False
